        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _roleManager.CreateAsync(new(DS.Role_Admin));
                    }
                    if (!await _roleManager.RoleExistsAsync(DS.Role_Cliente))
                    {
                        await _roleManager.CreateAsync(new(DS.Role_Cliente));
                    }
                    if (!await _roleManager.RoleExistsAsync(DS.Role_Inventario))
                    {
                        await _roleManager.CreateAsync(new(DS.Role_Inventario));
                    }
                    ...
                    //await _userManager.AddToRoleAsync(user, DS.Role_Admin); Esto le da el rol de Admin por defecto
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            return RedirectToAction("Idex", "Usuario", new { Area = "Admin" });
                        }
                    }
                }
