                    ...
                    if (bloqueo > hoy) {
                        ...
                        return `
                            <div class="text-center">
                                ...
                                <a onclick=BloquearDesbloquear('${data.id}') class="btn btn-danger text-white" style="cursor:ponter", width:150px>
                        ...
                        return `
                            <div class="text-center">
                                ...
                                <a onclick=BloquearDesbloquear('${data.id}') class="btn btn-success text-white" style="cursor:ponter", width:150px>
